...
static int asus_usb_hid_write(u8 vlaues, char asus_gp_command_id)
{
	...
	pr_debug(
		"[GAMEPAD_II] asus_usb_hid_write asus_gp_command_id: %d,value: %d\n",
...
static struct attribute *pwm_attrs[] = {
	...
	&dev_attr_blue_pwm.attr, &dev_attr_mode.attr,
	&dev_attr_apply.attr,	 &dev_attr_fw_ver.attr,
	&dev_attr_fw_mode.attr,	 &dev_attr_frame.attr,
	&dev_attr_mode2.attr,	 &dev_attr_led_on.attr,
	&dev_attr_speed.attr,	 NULL
};
...
static struct hid_device_id gamepad_idtable[] = {
	{ HID_USB_DEVICE(0x0B05, 0x7900), .driver_data = 0 },
