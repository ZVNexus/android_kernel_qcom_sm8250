...
#define TSPDRV_STOP_KERNEL_TIMER                                               \
	_IO(TSPDRV_IOCTL_GROUP, 1) /* obsolete, may be removed in future */
...
#define VIBE_OUTPUT_SAMPLE_SIZE                                                \
	60 /* DO NOT CHANGE - maximum number of samples */
...
#warning                                                                       \
	"*** Runtime recorder feature is ON for debugging which should be OFF in release version."
#warning                                                                       \
	"*** Please turn off the feature by removing VIBE_RUNTIME_RECODE definition."
#else
