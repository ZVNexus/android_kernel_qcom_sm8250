			       ...
			       char *data)
{
	...
	pr_debug(
		"[AURA_DT] ene_8k41_read_bytes : addr: 0x%x, buf[1] : 0x%x, buf[2] : 0x%x\n",
				...
				char value)
{
	...
	pr_debug(
		"[AURA_DT] ene_8k41_write_bytes : addr: 0x%x, buf[1] : 0x%x, buf[2] : 0x%x, value : 0x%x\n",
			     ...
			     struct ene_8k41_platform_data *pdata)
{
	...
	pdata->check_3v_gpio = of_get_named_gpio_flags(
		np, "ene8k41,check-3v-gpio", 0, &pdata->check_3v_flags);
