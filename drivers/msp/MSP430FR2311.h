...
#define ASUS_MOTOR_DRV_MANUAL_MODE                                             \
	_IOW(ASUS_MOTOR_DRV_IOC_MAGIC, 2, motorDrvManualConfig_t)
#define ASUS_MOTOR_DRV_STOP _IOW(ASUS_MOTOR_DRV_IOC_MAGIC, 3, int)
#define ASUS_MOTOR_DRV_GET_NAME                                                \
	_IOR(ASUS_MOTOR_DRV_IOC_MAGIC, 4, char[ASUS_MOTOR_NAME_SIZE])
#define ASUS_MOTOR_DRV_CLOSE                                                   \
	_IOR(ASUS_MOTOR_DRV_IOC_MAGIC, 5, char[ASUS_MOTOR_NAME_SIZE])

#define ASUS_MOTOR_DRV_AUTO_MODE_WITH_ANGLE                                    \
	_IOW(ASUS_MOTOR_DRV_IOC_MAGIC, 6, int)
