...
//ASUS BSP +++
#define CHGR_JEITA_HOT_THRESHOLD_LSB_REG	(CHGR_BASE + 0x95)
#define CHGR_JEITA_COLD_THRESHOLD_MSB_REG	(CHGR_BASE + 0x96)
#define CHGR_JEITA_COLD_THRESHOLD_LSB_REG	(CHGR_BASE + 0x97)
#define CHGR_JEITA_THOT_THRESHOLD_MSB_REG	(CHGR_BASE + 0x98)
#define CHGR_JEITA_THOT_THRESHOLD_LSB_REG	(CHGR_BASE + 0x99)
#define CHGR_JEITA_TCOLD_THRESHOLD_MSB_REG	(CHGR_BASE + 0x9A)
#define CHGR_JEITA_TCOLD_THRESHOLD_LSB_REG	(CHGR_BASE + 0x9B)
//ASUS BSP ---
...
#define DCDC_OTG_CURRENT_LIMIT_MASK		GENMASK(2, 0)
...
#define TYPEC_LEGACY_CABLE_TYPE_MASK			GENMASK(1, 0)
...
#define RESTART_THERMAL_BIT			BIT(2)	//ASUS BSP +++
...
#define AICL_RERUN_TIME_3S_VAL			0x00	//ASUS BSP +++
...
#define THERMREG_INOV_ENABLE			GENMASK(2, 0)
